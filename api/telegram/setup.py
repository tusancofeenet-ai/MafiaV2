...
The setup credential is accepted only through the Authorization header so it
never needs to appear in a URL or access log. Remove this endpoint after the
webhook has been configured and verified.
"""
